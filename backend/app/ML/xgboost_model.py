...
# ── SAVE ARTIFACTS ────────────────────────────────────────────────────────────
def save_artifacts(model, target_encoder, encoders, scaler, path):
    ...
    print(f"\n✅ Model and preprocessing artifacts saved to: {path}")

# ── MAIN ──────────────────────────────────────────────────────────────────────
if __name__ == "__main__":
    model = train_xgboost(X_train, X_test, y_train_enc, y_test_enc)

    # ─── SAVE TO backend/app/ML/models/ ──────────────────────────────────
    script_dir = os.path.dirname(os.path.abspath(__file__))
    models_dir = os.path.join(script_dir, 'models')
    models_path = os.path.join(models_dir, 'xgboost_model.pkl')   # ✅ correct name
    print(f"\nSaving to: {models_path}")
    save_artifacts(model, target_encoder, encoders, scaler, path=models_path)  # ✅ correct function
